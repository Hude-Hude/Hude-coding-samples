...
% Pre-processing: Assign predictors and labels for Setosa vs all
...
% Labels: Setosa (0), Versicolor & Virginica (1)
y = zeros(120, 1);
for i = 1:40
    y(i) = 0;  % Setosa is class 0
end
for i = 41:120
    y(i) = 1;  % Versicolor & Virginica are class 1
end
...
disp('class 0 represents "Setosa" and class 1 represents "Versicolor & Virginica"')
plotData(X, y);
